...
upsample_amnt = upsample_amnts(7);
...
function varargout = get_sim(fc_test, fc_train, nFFT, upsample_amnt, M_svr, varargin)
    directory_name = 'D:/simulations/svr_swap';
