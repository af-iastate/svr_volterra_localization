...
for fc=[fcs(2)]
    ...
    for ii=1:length(M_predists) 
        ...
        [train_EVM_worst, test_EVM_worst, train_EVM_avg, test_EVM_avg, tx_train_grid, tx_test_grid] = get_sim( ...
            fc, nFFT, M_predist, K_predist, 'train_EVM_worst', 'test_EVM_worst', 'train_EVM_avg', 'test_EVM_avg', 'tx_train_grid', 'tx_test_grid');
        ...
        figure(1)
        plot_train_test_const(fc, nFFT, M_predist, K_predist);
    ...
    title('Volt Lcl Post Predist. Avg. EVM')
    ...
    title('Volt Lcl Post Predist. Worst EVM')
    legend('Training', 'Test', 'Location', 'northeast')
    xlabel('M_{pred}')
    ylabel('dB')
...
function plot_train_test_const(fc, nFFT, M_predist, K_predist)
